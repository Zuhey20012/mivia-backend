...
exports.finalizeTryAtHomeFitting = exports.createEuropeanApparelEscrow = void 0;
...
exports.createEuropeanApparelEscrow = (0, https_1.onCall)(async (request) => {
    if (!request.auth)
    ...
    if (!garmentDoc.exists || !boutiqueDoc.exists) {
        throw new https_1.HttpsError("not-found", "Garment or boutique record missing.");
    }
    ...
    const fittingFeeCents = 499; // €4.99 concierge fitting fee
...
exports.finalizeTryAtHomeFitting = (0, https_1.onCall)(async (request) => {
...
//# sourceMappingURL=european_fashion_escrow.js.map