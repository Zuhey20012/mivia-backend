...
class AuthService extends ChangeNotifier {
  ...
  /// Vendors can always open the dashboard to set up their store; the server keeps an
  /// unverified store hidden from customers until an admin approves it.
  ...
  Future<String?> _applySession(Map<String, dynamic> data) async {
    ...
    if (user.role != kAppRole) {
      return 'This account is not a store account. Please use the matching Malvoya app.';
    }
    _currentUser = user;
